...
unsigned char m_seg_file[] = {
		  
		};

#define MAX_ARRAY_PRINTF        256
...
static void _handle_segment_parse(UploadSegment& m_cur_u_seg) {
	...
	if (crc16 == _decode_uint16_little(m_cur_u_seg.buffer + index)) {
		...
		//_dump_as_char(m_cur_u_seg.buffer+index, poly_length);
		{
			ByteBuffer bBuffer;
		...
		//_dump_as_char(m_cur_u_seg.buffer+index, comp_stream_length);
		{
			...
			SequenceUnpacker unpacker(bBuffer, 119);
			unpacker.unpack();
			int32_t tot_time = 0;
			for (size_t i=0; i < unpacker.original.size(); i++) {
			...
			printf("\n ");
			printf("TOT time = %ld vs. PR %u KOM %u \n ", tot_time, pr_time, kom_time);
		}
	}
}
